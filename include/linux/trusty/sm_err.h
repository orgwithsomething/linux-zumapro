...
#define SM_ERR_UNDEFINED_SMC		0xFFFFFFFF /* Unknown SMC (ARM DEN 0028A(0.9.0)) */
#define SM_ERR_INVALID_PARAMETERS	-2
#define SM_ERR_INTERRUPTED		-3	/* Got interrupted. Call back with restart SMC */
#define SM_ERR_UNEXPECTED_RESTART	-4	/* Got a restart SMC when we didn't expect it */
...
#define SM_ERR_FIQ_INTERRUPTED		-12	/* Got interrupted by FIQ. Call back with SMC_SC_RESTART_FIQ */
